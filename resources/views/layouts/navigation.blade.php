<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('peso.create')" :active="request()->routeIs('peso.*')">
                        {{ __('Registrar peso') }}
                    </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link :href="route('profile.parametros.edit')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('ingredientes.create')" :active="request()->routeIs('ingredientes.*')">
                {{ __('Ingredientes') }}
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('peso.create')" :active="request()->routeIs('peso.*')">
                {{ __('Registrar peso') }}
            </x-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('profile.parametros.edit')">
                    {{ __('Parámetros nutricionales') }}
                </x-responsive-nav-link>
