    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-end mt-4">
            @if (Route::has('password.request'))
                <a class="underline text-sm text-tudi-ink-3 hover:text-tudi-ink rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-tudi-lime-700" href="{{ route('password.request') }}">
